...
-- Données de la table `affecter`
INSERT INTO `affecter` VALUES ('10', 'directeur', '5', NULL);
INSERT INTO `affecter` VALUES ('15', 'encadrant', '5', NULL);
...
CREATE TABLE `approuver` (
  ...
  CONSTRAINT `fk_approuver_niveau` FOREIGN KEY (`id_approb`) REFERENCES `niveau_approbation` (`id_approb`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `approuver` VALUES ('7', '2', 'approuve', '2025-06-27 00:41:07', 'tout es op', '4');
INSERT INTO `approuver` VALUES ('7', '5', 'approuve', '2025-06-29 17:37:00', 'blablbalb', '4');
INSERT INTO `approuver` VALUES ('7', '12', 'approuve', '2025-07-03 11:19:30', 'de', '4');
INSERT INTO `approuver` VALUES ('7', '13', 'approuve', '2025-07-03 12:00:16', 'bon rapport', '4');
INSERT INTO `approuver` VALUES ('7', '14', 'approuve', '2025-07-03 12:24:00', 'rapport bien rediger', '4');
...
INSERT INTO `avoir` VALUES ('10', '16', '2019-02-12');
...
INSERT INTO `candidature_soutenance` VALUES ('1', '2004003', '2025-06-06 00:49:02', 'Rejetée', '2025-06-23 11:37:54', '6', 'Évaluation complète terminée');
INSERT INTO `candidature_soutenance` VALUES ('6', '2003003', '2025-06-23 10:23:24', 'Validée', '2025-06-26 23:11:22', '6', 'Évaluation complète terminée');
INSERT INTO `candidature_soutenance` VALUES ('7', '2003003', '2025-06-23 11:55:25', 'Validée', '2025-06-26 23:11:22', '6', 'Évaluation complète terminée');
...
INSERT INTO `candidature_soutenance` VALUES ('10', '2003006', '2025-07-03 08:46:06', 'Validée', '2025-07-03 10:02:39', '6', 'Évaluation complète terminée');
INSERT INTO `candidature_soutenance` VALUES ('11', '20230001', '2025-07-03 11:57:17', 'Validée', '2025-07-03 11:59:04', '6', 'Évaluation complète terminée');
INSERT INTO `candidature_soutenance` VALUES ('12', '20240001', '2025-07-03 12:15:41', 'Validée', '2025-07-03 12:19:39', '6', 'Évaluation complète terminée');
...
CREATE TABLE `compte_rendu_rapport` (
  ...
  CONSTRAINT `compte_rendu_rapport_ibfk_1` FOREIGN KEY (`id_CR`) REFERENCES `compte_rendu` (`id_CR`) ON DELETE CASCADE,
  CONSTRAINT `compte_rendu_rapport_ibfk_2` FOREIGN KEY (`id_rapport`) REFERENCES `rapport_etudiants` (`id_rapport`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Données de la table `compte_rendu_rapport`
INSERT INTO `compte_rendu_rapport` VALUES ('28', '5');
INSERT INTO `compte_rendu_rapport` VALUES ('28', '12');
...
INSERT INTO `deposer` VALUES ('2003003', '2', '2025-06-25 14:49:28');
INSERT INTO `deposer` VALUES ('2003006', '12', '2025-07-03 10:05:55');
INSERT INTO `deposer` VALUES ('2004003', '5', '2025-06-27 20:09:26');
INSERT INTO `deposer` VALUES ('20230001', '13', '2025-07-03 11:59:56');
INSERT INTO `deposer` VALUES ('20240001', '14', '2025-07-03 12:22:53');
...
INSERT INTO `ecue` VALUES ('7', '8', 'Economie 1', '2', NULL);
INSERT INTO `ecue` VALUES ('9', '8', 'Economie 2', '2', NULL);
INSERT INTO `ecue` VALUES ('10', '13', 'Suites et fonctions', '3', NULL);
INSERT INTO `ecue` VALUES ('11', '13', 'Calcul intégral', '2', NULL);
INSERT INTO `ecue` VALUES ('12', '14', 'Elements de logique', '2', NULL);
INSERT INTO `ecue` VALUES ('13', '14', 'Structures algébriques', '3', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_mysql500_ci;
...
INSERT INTO `enseignants` VALUES ('16', 'Diarra', 'Mamadou', 'diarramamadou@gmail.com', '2', 'Administratif');
...
INSERT INTO `etudiants` VALUES ('20230001', 'Krouma', 'Franck', 'kf@gmail.com', '1998-12-22', 'Homme', '2023-2024');
INSERT INTO `etudiants` VALUES ('20240001', 'goa', 'Harley', 'goaharley@gmail.com', '1998-05-24', 'Homme', '2024-2025');
...
CREATE TABLE `evaluations_rapports` (
  ...
  KEY `id_rapport` (`id_rapport`),
  CONSTRAINT `evaluations_rapports_ibfk_1` FOREIGN KEY (`id_evaluateur`) REFERENCES `enseignants` (`id_enseignant`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `evaluations_rapports_ibfk_2` FOREIGN KEY (`id_rapport`) REFERENCES `rapport_etudiants` (`id_rapport`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Données de la table `evaluations_rapports`
INSERT INTO `evaluations_rapports` VALUES ('2', '5', '16', 'rejeter', 'Moi j\'ai une idée ', '2025-06-30 16:28:25', NULL);
INSERT INTO `evaluations_rapports` VALUES ('3', '5', '2', 'rejeter', 'il n\'a pas une bonne idée', '2025-06-30 16:29:54', '2025-06-30 16:30:28');
INSERT INTO `evaluations_rapports` VALUES ('4', '2', '2', 'valider', 'ouiii', '2025-06-30 16:53:31', NULL);
INSERT INTO `evaluations_rapports` VALUES ('5', '2', '7', 'valider', 'tout est bon', '2025-07-01 14:23:23', NULL);
INSERT INTO `evaluations_rapports` VALUES ('6', '5', '7', 'rejeter', 'Gomez fait pas les bonnes chose', '2025-07-01 14:24:14', NULL);
INSERT INTO `evaluations_rapports` VALUES ('7', '2', '12', 'valider', 'op', '2025-07-01 14:26:23', NULL);
INSERT INTO `evaluations_rapports` VALUES ('8', '5', '12', 'valider', 'ah les gars', '2025-07-01 14:27:33', NULL);
INSERT INTO `evaluations_rapports` VALUES ('9', '2', '16', 'valider', 'bien', '2025-07-01 14:37:24', NULL);
INSERT INTO `evaluations_rapports` VALUES ('13', '12', '7', 'valider', 'oui j\'aime ce rapport', '2025-07-03 11:21:02', NULL);
INSERT INTO `evaluations_rapports` VALUES ('14', '12', '2', 'valider', 'le rapport est bon', '2025-07-03 11:34:07', NULL);
INSERT INTO `evaluations_rapports` VALUES ('15', '12', '16', 'valider', 'ouii', '2025-07-03 11:35:43', NULL);
INSERT INTO `evaluations_rapports` VALUES ('16', '12', '12', 'valider', 'oui très bon rapport', '2025-07-03 11:36:38', NULL);
INSERT INTO `evaluations_rapports` VALUES ('17', '13', '7', 'valider', 'oui', '2025-07-03 12:00:51', NULL);
INSERT INTO `evaluations_rapports` VALUES ('18', '14', '7', 'valider', 'valide', '2025-07-03 12:25:33', NULL);
...
CREATE TABLE `evaluer` (
  ...
  `note` int NOT NULL,
  KEY `Key_evaluer_ecue` (`id_ecue`),
  KEY `Key_evaluer_enseignant` (`id_enseignant`),
  KEY `Key_evaluer_etudiant` (`num_etu`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_mysql500_ci;
...
INSERT INTO `informations_stage` VALUES ('6', '2003006', '9', '2024-07-31', '2025-03-01', 'Developpement IA generative', 'blablablablablabalba', 'Kouamé Jean', 'kj@gmail.com', '0105030604');
INSERT INTO `informations_stage` VALUES ('7', '20230001', '10', '2023-09-02', '2025-02-03', 'Developpement  de ia', 'le stage etait bon', 'Badro Celeste', 'bdc@gmail.com', '0708090605');
INSERT INTO `informations_stage` VALUES ('8', '20240001', '10', '2024-05-14', '2024-01-16', 'Developpement  de ia', 'Candidature ', 'Badro Celeste', 'bdc@gmail.com', '0708090605');
...
INSERT INTO `inscriptions` VALUES ('17', '2003006', '9', '22221', '2025-06-03 00:55:05', 'En cours', '2', '0.00', '1235000.00');
...
INSERT INTO `inscriptions` VALUES ('31', '20230001', '9', '22423', '2025-07-03 11:42:46', 'En cours', '1', '0.00', '1235000.00');
INSERT INTO `inscriptions` VALUES ('32', '20240001', '9', '22524', '2025-07-03 12:11:43', 'En cours', '1', '0.00', '1235000.00');
...
INSERT INTO `notes` VALUES ('16', '2003006', '73', NULL, '10.00', 'passable', '2025-07-03 08:52:07', '2025-07-03 08:52:07');
INSERT INTO `notes` VALUES ('17', '2003006', '81', NULL, '13.00', 'bien', '2025-07-03 08:52:07', '2025-07-03 08:52:07');
INSERT INTO `notes` VALUES ('18', '2003006', '76', NULL, '10.00', 'passable', '2025-07-03 08:52:07', '2025-07-03 08:52:07');
INSERT INTO `notes` VALUES ('19', '2003006', '77', NULL, '15.00', 'bien', '2025-07-03 08:52:07', '2025-07-03 08:52:07');
INSERT INTO `notes` VALUES ('20', '2003006', '74', NULL, '10.00', 'passable', '2025-07-03 08:52:07', '2025-07-03 08:52:07');
INSERT INTO `notes` VALUES ('21', '2003006', '79', NULL, '10.00', 'passable', '2025-07-03 08:52:07', '2025-07-03 08:52:07');
INSERT INTO `notes` VALUES ('22', '2003006', '75', NULL, '10.00', 'passable', '2025-07-03 08:52:07', '2025-07-03 08:52:07');
INSERT INTO `notes` VALUES ('23', '2003006', '80', NULL, '10.00', 'passable', '2025-07-03 08:52:07', '2025-07-03 08:52:07');
INSERT INTO `notes` VALUES ('24', '2003006', '78', NULL, '10.00', 'passable', '2025-07-03 08:52:07', '2025-07-03 08:52:07');
INSERT INTO `notes` VALUES ('25', '20230001', '73', NULL, '10.00', '', '2025-07-03 11:58:43', '2025-07-03 11:58:43');
INSERT INTO `notes` VALUES ('26', '20230001', '81', NULL, '15.00', '', '2025-07-03 11:58:43', '2025-07-03 11:58:43');
INSERT INTO `notes` VALUES ('27', '20230001', '76', NULL, '12.00', '', '2025-07-03 11:58:43', '2025-07-03 11:58:43');
INSERT INTO `notes` VALUES ('28', '20230001', '77', NULL, '10.00', '', '2025-07-03 11:58:43', '2025-07-03 11:58:43');
INSERT INTO `notes` VALUES ('29', '20230001', '74', NULL, '10.00', '', '2025-07-03 11:58:43', '2025-07-03 11:58:43');
INSERT INTO `notes` VALUES ('30', '20230001', '79', NULL, '10.00', '', '2025-07-03 11:58:43', '2025-07-03 11:58:43');
INSERT INTO `notes` VALUES ('31', '20230001', '75', NULL, '10.00', '', '2025-07-03 11:58:43', '2025-07-03 11:58:43');
INSERT INTO `notes` VALUES ('32', '20230001', '80', NULL, '10.00', '', '2025-07-03 11:58:43', '2025-07-03 11:58:43');
INSERT INTO `notes` VALUES ('33', '20230001', '78', NULL, '10.00', '', '2025-07-03 11:58:43', '2025-07-03 11:58:43');
INSERT INTO `notes` VALUES ('34', '20240001', '73', NULL, '14.00', '', '2025-07-03 12:19:00', '2025-07-03 12:19:00');
INSERT INTO `notes` VALUES ('35', '20240001', '81', NULL, '12.00', '', '2025-07-03 12:19:00', '2025-07-03 12:19:00');
INSERT INTO `notes` VALUES ('36', '20240001', '76', NULL, '10.00', '', '2025-07-03 12:19:00', '2025-07-03 12:19:00');
INSERT INTO `notes` VALUES ('37', '20240001', '77', NULL, '8.00', '', '2025-07-03 12:19:00', '2025-07-03 12:19:00');
INSERT INTO `notes` VALUES ('38', '20240001', '74', NULL, '10.00', '', '2025-07-03 12:19:00', '2025-07-03 12:19:00');
INSERT INTO `notes` VALUES ('39', '20240001', '79', NULL, '10.00', '', '2025-07-03 12:19:00', '2025-07-03 12:19:00');
INSERT INTO `notes` VALUES ('40', '20240001', '75', NULL, '10.00', '', '2025-07-03 12:19:00', '2025-07-03 12:19:00');
INSERT INTO `notes` VALUES ('41', '20240001', '80', NULL, '16.00', '', '2025-07-03 12:19:00', '2025-07-03 12:19:00');
INSERT INTO `notes` VALUES ('42', '20240001', '78', NULL, '13.00', '', '2025-07-03 12:19:00', '2025-07-03 12:19:00');
...
INSERT INTO `occuper` VALUES ('9', '16', '2016-05-24');
...
CREATE TABLE `pister` (
  ...
  `nom_table` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_creation` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_piste`),
  KEY `fk_pister_utilisateur` (`id_utilisateur`),
  CONSTRAINT `fk_pister_utilisateur` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateur` (`id_utilisateur`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Données de la table `pister`
INSERT INTO `pister` VALUES ('1', '5', 'Connexion', 'Succès', 'utilisateur', '2025-07-23 13:29:39');
INSERT INTO `pister` VALUES ('2', '5', 'Accès', 'Succès', 'tableau_de_bord', '2025-07-23 13:29:50');
INSERT INTO `pister` VALUES ('3', '5', 'Accès', 'Succès', 'tableau_de_bord', '2025-07-23 13:31:48');
INSERT INTO `pister` VALUES ('4', '5', 'Connexion', 'Succès', 'utilisateur', '2025-07-23 13:40:09');
INSERT INTO `pister` VALUES ('5', '5', 'Accès', 'Succès', 'tableau_de_bord', '2025-07-23 13:40:23');
INSERT INTO `pister` VALUES ('6', '59', 'Connexion', 'Succès', 'utilisateur', '2025-07-23 13:44:22');
INSERT INTO `pister` VALUES ('7', '59', 'Création', 'Succès', 'candidature_soutenance', '2025-07-23 13:45:05');
INSERT INTO `pister` VALUES ('8', '59', 'Suppression', 'Succès', 'rapport_etudiants', '2025-07-23 13:45:19');
INSERT INTO `pister` VALUES ('9', '59', 'Suppression', 'Succès', 'rapport_etudiants', '2025-07-23 13:45:24');
INSERT INTO `pister` VALUES ('10', '79', 'Connexion', 'Succès', 'utilisateur', '2025-07-23 13:47:50');
INSERT INTO `pister` VALUES ('11', '35', 'Connexion', 'Succès', 'utilisateur', '2025-07-23 13:50:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_mysql500_ci;

-- Données de la table `rapport_etudiants`
INSERT INTO `rapport_etudiants` VALUES ('2', '2003003', 'nom teste de rapports', '2025-06-25 11:20:16', 'theme testes de rapport', 'rapport_2.html', 'valider', '2025-06-26 10:13:13', '1137', '1', 'valide');
INSERT INTO `rapport_etudiants` VALUES ('5', '2004003', 'Génération d\'une base de connaissance pour l\'IA', '2025-06-27 02:24:49', 'Intégration d\'une base intelligente', 'rapport_5.html', 'rejeter', '2025-06-27 02:24:49', '11780', '1', 'desapprouve_commission');
INSERT INTO `rapport_etudiants` VALUES ('10', '2004003', 'Analyse de données', '2025-06-28 20:10:04', 'Régression multiple', 'rapport_10.html', 'en_attente', '2025-06-28 20:10:04', '11771', '1', 'en_cours');
INSERT INTO `rapport_etudiants` VALUES ('12', '2003006', 'IA générative et son impact sur l\'art moderne', '2025-07-03 10:05:45', 'Impact de l\'IA générative', 'rapport_12.html', 'valider', '2025-07-03 10:05:55', '11771', '1', 'valide');
INSERT INTO `rapport_etudiants` VALUES ('13', '20230001', 'Raport test', '2025-07-03 11:59:50', 'test theme', 'rapport_13.html', 'en_cours', '2025-07-03 11:59:56', '11771', '1', 'approuve_communication');
INSERT INTO `rapport_etudiants` VALUES ('14', '20240001', 'Raport test', '2025-07-03 12:22:12', 'test theme', 'rapport_14.html', 'en_cours', '2025-07-03 12:22:53', '11771', '1', 'approuve_communication');
...
INSERT INTO `rattacher` VALUES ('11', '43');
...
INSERT INTO `reclamations` VALUES ('4', '2004003', 'rogggggggggggggggggggggggggg', 'zptmffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 'Académique', 'Moyenne', 'En attente', '2025-06-27 21:54:42', '2025-06-27 21:54:42', NULL);
...
INSERT INTO `resume_candidature` VALUES ('6', '2003006', '10', '{\"scolarite\":{\"statut\":\"\\u00c0 jour\",\"montant_total\":\"1 235 000 FCFA\",\"montant_paye\":\"1 235 000 FCFA\",\"dernier_paiement\":\"03\\/07\\/2025\",\"validation\":\"valid\\u00e9\"},\"stage\":{\"entreprise\":\"DIGICORP\",\"sujet\":\"Developpement IA generative\",\"periode\":\"31\\/07\\/2024 - 01\\/03\\/2025\",\"encadrant\":\"Kouam\\u00e9 Jean\",\"validation\":\"valid\\u00e9\"},\"semestre\":{\"semestre\":\"Semestre 9\",\"moyenne\":\"10.89\\/20\",\"unites\":\"30\\/30 cr\\u00e9dits valid\\u00e9s\",\"validation\":\"valid\\u00e9\"}}', 'Validée', '2025-07-03 10:02:39');
INSERT INTO `resume_candidature` VALUES ('7', '20230001', '11', '{\"scolarite\":{\"statut\":\"\\u00c0 jour\",\"montant_total\":\"1 235 000 FCFA\",\"montant_paye\":\"1 235 000 FCFA\",\"dernier_paiement\":\"03\\/07\\/2025\",\"validation\":\"valid\\u00e9\"},\"stage\":{\"entreprise\":\"SODECI\",\"sujet\":\"Developpement  de ia\",\"periode\":\"02\\/09\\/2023 - 03\\/02\\/2025\",\"encadrant\":\"Badro Celeste\",\"validation\":\"valid\\u00e9\"},\"semestre\":{\"semestre\":\"Semestre 9\",\"moyenne\":\"10.78\\/20\",\"unites\":\"30\\/30 cr\\u00e9dits valid\\u00e9s\",\"validation\":\"valid\\u00e9\"}}', 'Validée', '2025-07-03 11:59:04');
INSERT INTO `resume_candidature` VALUES ('8', '20240001', '12', '{\"scolarite\":{\"statut\":\"\\u00c0 jour\",\"montant_total\":\"1 235 000 FCFA\",\"montant_paye\":\"1 235 000 FCFA\",\"dernier_paiement\":\"03\\/07\\/2025\",\"validation\":\"valid\\u00e9\"},\"stage\":{\"entreprise\":\"SODECI\",\"sujet\":\"Developpement  de ia\",\"periode\":\"14\\/05\\/2024 - 16\\/01\\/2024\",\"encadrant\":\"Badro Celeste\",\"validation\":\"valid\\u00e9\"},\"semestre\":{\"semestre\":\"Semestre 9\",\"moyenne\":\"11.44\\/20\",\"unites\":\"30\\/30 cr\\u00e9dits valid\\u00e9s\",\"validation\":\"valid\\u00e9\"}}', 'Validée', '2025-07-03 12:19:39');
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_mysql500_ci;
...
INSERT INTO `traitement` VALUES ('39', 'archives_dossiers_soutenance', 'Archives des rapports de soutenance', 'fa-inbox', '5');
...
INSERT INTO `traitement` VALUES ('43', 'archive_comptes_rendus', 'Archive des comptes rendus', 'fa-book', '9');
...
INSERT INTO `ue` VALUES ('48', 'Analyse de données', '8', '19', '22524', '3', NULL);
...
CREATE TABLE `utilisateur` (
  ...
  `reset_token` varchar(255) COLLATE utf8mb3_general_mysql500_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_mysql500_ci;

-- Données de la table `utilisateur`
INSERT INTO `utilisateur` VALUES ('5', 'Koua Brou', '5', '5', '5', 'Actif', 'ahopaul18@gmail.com', '$2y$10$MyjMfHbm21e1dIbT0g2n8eUsQrWPYsyaSQdQryQ5Q2svGPrleFLrq', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('27', 'Kouakou Mathias', '6', '12', '5', 'Actif', 'axelangegomez@gmail.com', '$2y$10$QXdyHw8Tky94eHKJY.Bw/OoQ/t9h1cNn/itHTZa7wgRHJxtKb9URC', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('34', 'Yah Christine', '4', '6', '4', 'Actif', 'yahchristine@gmail.com', '$2y$10$StdfqOOpnOBUf1kSZnhHeu6TqUiXVWtfqI73AKv4v7Cv2NjjKqNna', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('35', 'N\'goran Durand', '4', '8', '5', 'Actif', 'ngorandurand@gmail.com', '$2y$10$5ZqH0attuqgCtWVAhowPY.BWHkiNEbu2QyPDaTt71SoIexRTr5qvK', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('36', 'Brou Patrice', '5', '11', '5', 'Actif', 'angeaxelgomez@gmail.com', '$2y$10$QtMW8goQLrH.om8q1mlgo.tJwA1AGFc./uZpOLhoo4g2z7p46OCrm', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('39', 'N\'golo Konaté', '6', '12', '5', 'Actif', 'ngolokonate@yahoo.fr', '$2y$10$o7fxEokbRfMLFoGPOS1TpOFuxjFQ3TFzMMV4mukNEWLs9aNxGjr/u', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('40', 'Nindjin Malan', '6', '12', '5', 'Actif', 'nindjinmalan@gmail.com', '$2y$10$f0Nq70iGpanY5FrbCZI2G.fJ.aj8oDu05Y2Gi5y1LjsrcDc5M3TXa', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('59', 'Aka Prince', '7', '13', '5', 'Actif', 'prince.aka@miage.edu', '$2y$10$sO1N9ycvpm//IDHF0fknWuCgq1XvGxJdh9KSYO1zW6nWYzkjMRfdC', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('79', 'Seri Marie Christine', '4', '7', '5', 'Actif', 'noemietra27@gmail.com', '$2y$10$mwe8xFfPtzIIzfo.5VWT2./jH8l/kgIVlSjPq5mZyyzUzFGk3alpO', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('81', 'Brou Kouamé Wa Ambroise', '7', '13', '5', 'Actif', 'kouame.brou@miage.edu', '$2y$10$keRv.zYilWhkPEcFa8zF/uf4fu4mTbHkfF9orQS9zThS3BDU0b/He', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('82', 'Coulibaly Pécory Ismaèl', '7', '13', '5', 'Actif', 'pecory.coulibaly@miage.edu', '$2y$10$HliFB0N/ZfI2qWPnclw01O8lBMcJjjhhxyqlLqGWjTRRMfnj.WWGC', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('83', 'Diomandé Gondo Patrick', '7', '13', '5', 'Actif', 'gondo.diomande@miage.edu', '$2y$10$zYnzDrTSquYQmaIYOFkq7eKzL9kqYS/OHO99IEv0PijUvkO.uCVK6', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('84', 'Ekponou Georges', '7', '13', '5', 'Actif', 'georges.ekponou@miage.edu', '$2y$10$X8VsR9CHU/VwYBaHCrf6MuDhJ9JkUv0Ncz7t1RyGnsEn2om0IMDw2', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('85', 'Guiégui Arnaud Kévin Boris', '7', '13', '5', 'Actif', 'arnaud.guiegui@miage.edu', '$2y$10$MDqlwgj2HvdJ5NZ0zSF59eyL1ZTkRNa9xidM8guQpVZUlzgziqJjG', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('86', 'Kéi Ninsémon Hervé', '7', '13', '5', 'Actif', 'herve.kei@miage.edu', '$2y$10$O1mce8rBqd8FMPOEEOzz8u72lU1fYYACaNRl64vs0IygVbKRcPHkK', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('87', 'Kinimo Habia Elvire', '7', '13', '5', 'Actif', 'elvire.kinimo@miage.edu', '$2y$10$Eb5ji/2./UjVCJFz2kKXuuiCsjgJooZAJYE5woBs6H9BiESPZpiqu', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('88', 'Kouadio Donald', '7', '13', '5', 'Actif', 'donald.kouadio@miage.edu', '$2y$10$2.Eg0s563GbxmHKklA7SjuPNj.2AgWk7KIInerEOKzOX7VEd3UP.W', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('89', 'Diarra Mamadou', '5', '11', '5', 'Actif', 'diarramamadou@gmail.com', '$2y$10$okN994fkmPzZaGIH2hY0LutY5em6OtuZkrOt2m.IAqmQfuglUx0e.', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('90', 'Wah Médard', '5', '11', '5', 'Actif', 'wahmedard@gmail.com', '$2y$10$S5rM7r6EGutGxCot0BVfneN7kNueWfWrUnU2U4vJDaej41aMEIF2e', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('91', 'Krouma Franck', '7', '13', '5', 'Actif', 'kf@gmail.com', '$2y$10$JI5/y9HR1sJAOfUrq7ownevcqDoNZ9OuWIHS6dyLELrcJmHFO/wwi', NULL, NULL);
INSERT INTO `utilisateur` VALUES ('92', 'goa Harley', '7', '13', '5', 'Actif', 'goaharley@gmail.com', '$2y$10$UeEak2JVOxpj/6wm1KxIQuhWHsJE6eqzTMbza2IcA3Kl2BBEQXWbi', NULL, NULL);
...
-- Données de la table `valider`
INSERT INTO `valider` VALUES ('2', '2', '2025-07-02 00:44:32', 'le rapport est bien structurer et tout est bien', 'valider');
INSERT INTO `valider` VALUES ('2', '5', '2025-07-01 22:59:34', 'Décision finale automatique', 'rejeter');
INSERT INTO `valider` VALUES ('2', '12', '2025-07-03 11:37:13', 'Le rapport est bon dans l\'ensemble et il y a rien a ajouté', 'valider');
...
INSERT INTO `versements` VALUES ('57', '17', '100000.00', '2025-07-03 08:46:28', 'Tranche', 'Espèce');
INSERT INTO `versements` VALUES ('58', '17', '300000.00', '2025-07-03 08:47:43', 'Tranche', 'Espèce');
INSERT INTO `versements` VALUES ('59', '17', '135000.00', '2025-07-03 10:01:49', 'Tranche', 'Espèce');
INSERT INTO `versements` VALUES ('60', '17', '30000.00', '2025-07-03 10:02:16', 'Tranche', 'Virement');
INSERT INTO `versements` VALUES ('61', '31', '670000.00', '2025-07-03 11:42:46', 'Premier versement', 'Espèce');
INSERT INTO `versements` VALUES ('62', '31', '565000.00', '2025-07-03 11:58:07', 'Tranche', 'Espèce');
INSERT INTO `versements` VALUES ('63', '32', '670000.00', '2025-07-03 12:11:43', 'Premier versement', 'Espèce');
INSERT INTO `versements` VALUES ('64', '32', '565000.00', '2025-07-03 12:17:54', 'Tranche', 'Carte bancaire');
